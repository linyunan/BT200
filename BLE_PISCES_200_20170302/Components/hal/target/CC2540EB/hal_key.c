...
#define HAL_KEY_SW_1_ICTLBIT  BV(4) /* P0IEN - P0.1 enable/disable bit */
...
#define HAL_KEY_SW_3_ICTLBIT  BV(7) /* P1IEN - P1.6 enable/disable bit */
...
#define HAL_KEY_SW_1_EDGEBIT  BV(2) /* P1ICONH */
#define HAL_KEY_SW_2_EDGEBIT  BV(2) /* P1ICONH */
#define HAL_KEY_SW_3_EDGEBIT  BV(2) /* P1ICONH */
...
//    HAL_KEY_SW_3_PXIFG =( uint8 ) ~(HAL_KEY_SW_3_BIT); /* Clear Interrupt Flag */
  ...
  if (valid)
  {
//    osal_start_timerEx (Hal_TaskID, HAL_KEY_EVENT, HAL_KEY_DEBOUNCE_VALUE);//HAL_KEY_DEBOUNCE_VALUE
    osal_set_event (Hal_TaskID, HAL_KEY_EVENT );
  }
...
//   osal_set_event (Hal_TaskID, HAL_KEY_EVENT );
  ...
  */
  ...
  HAL_KEY_SW_1_PXIFG = 0;//&= ~(BV(4));
  HAL_KEY_SW_2_PXIFG = 0;//&= ~(BV(6));
